...
<head>
    ...
    <style>
        ...
        .icon-input {
    font-family: 'Font Awesome 5 Free'; /* Asegúrate de que la fuente de iconos esté cargada */
    padding-left: 30px; /* Espacio a la izquierda para el icono */
    background-image: none; /* Elimina cualquier imagen de fondo predeterminada */
}

/* Estilos adicionales para el icono */
.icon-input::before {
    content: "\f27a"; /* Código Unicode del icono */
    position: absolute;
    left: 10px; /* Ajusta la posición horizontal del icono */
    top: 50%; /* Ajusta la posición vertical del icono */
    transform: translateY(-50%);
    font-size: 16px; /* Ajusta el tamaño del icono */
    color: #555; /* Ajusta el color del icono */
}
    </style>
</head>
