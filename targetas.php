...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.min.js"></script>
    ...
    .custom-modal-body {
        ...
        padding: 15px; /* Ajusta el espaciado interior del cuerpo del modal */
    }
}
        </style>
    </head>
            ...
            <div class="row justify-content-center">
                ...
                if ($resultado->num_rows > 0) {
                    ...
                    while ($fila = $resultado->fetch_assoc()) {
                        ...
                        echo '<p class="card-text">$' . $fila["price"] . '</p>';
                        echo '<a href="#" class="btn btn-danger align-self-center">Agregar A Carrito</a>';
                        echo '</div>';
                        echo '</div>';
                        echo ' </div>';
                        ...
                        echo '<div id="carousel' . $counter . '" class="carousel slide" data-bs-ride="carousel">';
                        ...
                        echo '</div>';
                        echo '<div class="card-body d-flex flex-column justify-content-center">';
                        echo ' <h5 class="card-title ">Descripcion y Caracteristicas</h5>';
                        echo ' <br>';
                        echo '<p class="card-text text-justify">' . $fila["description"] . '</p>';
                        echo ' <a href="#" class="btn btn-danger align-self-center">Agregar A Carrito</a>';
                        echo ' </div>';
                        echo '</div>';
                        echo ' </div>';
